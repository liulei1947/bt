...
//			break;
	...
	private void publish(final String commitContent){
		...
		figureFile.uploadblock(mContext, new UploadFileListener() {
	...
	private void publishWithoutFigure(final String commitContent,
		...
		final SeePic qiangYu = new SeePic();
		qiangYu.setAuthor(user);
		qiangYu.setFilmName(commitContent);
		if(figureFile!=null){
			qiangYu.setindexImageUrl(figureFile);
		}
		qiangYu.setLove(0);
		qiangYu.setHate(0);
		qiangYu.setShare(0);
