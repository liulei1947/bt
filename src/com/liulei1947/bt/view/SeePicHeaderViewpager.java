...
import com.liulei1947.bt.ui.SeePicCommentActivity;
 ...
 */
@SuppressLint("NewApi")
public class SeePicHeaderViewpager{
	int pagerPosition;
	int imageCount;
	int Count;
    ...
    //*************************************************************************
    public SeePicHeaderViewpager(Context context,ListView listView) {
  ...
  //****************************************************************
  		...
  		public void addHeadView() {
  	        ...
  	        headerImagePagerAdapter=new HeaderImagePagerAdapter(mcontext,SeePicHeaderData);
  ...
  //**************************************************
  	public void onImageGridClick(int position) {
  		...
  		Intent intent = null;
		try {
			SeePic pd = SeePicHeaderData.get(position);
			intent = new Intent();
			intent.putExtra("data", pd);
			intent.setClass(mcontext, SeePicCommentActivity.class);
	...
	public void queryHeaderdata(){
		...
		query.findObjects(mcontext, new FindListener<SeePic>() {
		    @Override
		    public void onSuccess(List<SeePic> showpicturesinfo) {
		        // TODO Auto-generated method stub
		    	
		    	SeePicHeaderData=showpicturesinfo;
	...
	private class HeaderImagePagerAdapter extends PagerAdapter {
			...
			List<SeePic> info;
			public HeaderImagePagerAdapter(Context context, List<SeePic> info2) {
				this.info=info2;
